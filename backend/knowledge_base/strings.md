# Strings
- Text is a string data type (`str`)

## Creating A String
- Can be a bunch of characters or one single character
- Can be made using a single or double quote or triple quotes

## String Concatenation
- Strings can be connected together with `+`
...
## String Formatting
- Used to insert information into strings
...
```
- Can also use the -1 to splice only the last index
- Reversing can be done simply by [::-1]
- Can also skip certain characters [::2]. this will keep every second character (including the first)

### String Methods
- Useful for making changes to strings
- Examples: capitalize(), title(), or swapcase()